...
calcMaxGain('10 7 -3 -10 4 2 8 -2 4 -5 -6');
calcMaxGain('7 -3 -10 4 2 8 -2 4 -5 -2');
...
const inWords = () => {
  ...
  process.stdin.on('data', (input) => {
    ...
    if (input === 'exit') {
      ...
      let output = numTowords(num);
      console.log(output + 'Dollars');
    }
  });
};
...
const numTowords = (n) => {
  ...
  return (
    numTowords(~~(n / 1000000)) +
    'Million' +
    (n % 1000 != 0 ? '' + numTowords(n % 1000000) : '')
  );
};
